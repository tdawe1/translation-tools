...
def run_smoke_test():
    ...
    cmd = [
        ...
        "--csv-report"  # This option ensures a bilingual CSV is generated by the translation script.
    ]
    # The --csv-report flag triggers the script to generate a bilingual CSV file for reporting.
