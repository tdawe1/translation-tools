...
async def test_orchestrator_integration():
    ...
    # Mock the underlying batch translation call. Prefer the docx orchestrator hook,
    # but fall back to the PPTX helper if the docx machinery is unavailable in this branch.
